...
Let's face it, I'm not going to write much here.
So here you go, have an acknowledgement post.
The website was built using Jekyll. The theme is BlackDoc.
Below, you can find the default posts that come with jekyll and blackdoc.
